...
const { startQRService, PORT } = require('./qrService');
...
function printQr(url) {
    ...
    console.log(`[扫码登录] 若二维码显示异常，可直接打开链接: http://localhost:${PORT}/qr?data=${encodeURIComponent(url)}`);
    console.log('');
}
